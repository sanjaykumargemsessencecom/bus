...
describe('Admin Reservation Page', () => {
  ...
  context('Admin Is Doing A Reservation', function(){
    
    it('Admin Should Be Able To Do Reservation', () => {
  ...
  context('Admin Should Be Able To Cancel A Reservation', function(){

    it('admin should able to cancel his reservation', () => {
