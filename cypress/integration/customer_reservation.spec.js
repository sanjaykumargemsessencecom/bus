...
describe('Customer Reservation Page', () => {
	 beforeEach(() => {
  ...
  context('Customer Is Doing A Reservation', function(){    
    it('Customer Should Be Able To Do Reservation', () => {
  ...
  context('Customer Is Canceling His A Reservation', function(){   
    it('customer should be able to cancel his reservation', () => {
